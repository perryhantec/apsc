...
<div class="menu-creation-index">
  ...
  <p>
    ...
    ?>
    &nbsp;
    <?php // Html::a(Yii::t('app',"Home Reorder"),['menu/home-reorder'], ['class' => 'popupModal btn btn-default']);
    ?>
...
*/
      [
        'class' => 'kartik\grid\EditableColumn',
          ...
          'vAlign'=>'middle',
          'readonly' => true,
          'filter' => Definitions::getMenuType(),
      ...
      [
        'class' => 'kartik\grid\EditableColumn',
          ...
          'readonly' => true,
            'format' => 'raw',
          'filter' => Definitions::getMenuList(),
          'value' => function($model){
...
$gridColumns = array_merge($gridColumns, [
      ...
      [
        ...
        'value' => function($model) {
            ...
            // return Definitions::getBooleanDescription($model->display_home);
/*
          $value = $model->status;
...
*/
      ...
      [
        ...
        'readonly' => true,
        'value'=> function($data){
                    return (\common\models\Menu::getMenuNumbers($data->type+1, $data->id)>0)?
                     Html::a(Yii::t('app',"Reorder"),['menu/reorder','id'=>$data->id],

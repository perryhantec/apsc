...
use backend\models\PageType2Search;
use backend\models\PageType2Reorder;
use common\models\PageType2;
// use common\models\PageType4Category;
// use backend\models\PageType4CategorySearch;
use common\models\Definitions;


class Pagetype2Controller extends Controller
{
...
//Page Type4
    public function actionIndex($id)
    {
      ...
      $searchModel = new PageType2Search();
    ...
    public function actionReorder($id)
    {
      ...
      $model = new PageType2Reorder(['MID'=>$menu_model->id]);
    ...
    private function findMenu($id) {
        $model = \common\models\Menu::find()->where(['id' => $id, 'page_type' => 2])->one();
    ...
    private function findPageType2($id) {
        $model = PageType2::findOne($id);

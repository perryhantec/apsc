...
//     public $roles = [self::ROLE_ADMIN => 'admin',  self::ROLE_USER=>'user', self::ROLE_MEMBER => 'member'];
    ...
    {
        return $this->hasMany(AdminUserAuditLog::className(), ['admin_user_id' => 'id']);
    }
    
    public function log($type, $msg, $ip=null)
    {
        $model = new AdminUserAuditLog([
    ...
    public function logLogin($msg, $ip=null)
    {
        return $this->log(AdminUserAuditLog::TYPE_LOGIN, $msg, $ip);
    }
        
    public function getOrderAuditLogs()
    {
        return $this->hasMany(OrderAuditLog::className(), ['admin_user_id' => 'id']);
    }

...
//             [['email'], 'required'],
            // [['company_name_tw', 'company_name_cn', 'company_name_en', 'website', 'phone', 'fax', 'whatsapp', 'facebook', 'instagram', 'youtube'], 'string', 'max' => 255],
            [['title', 'address', 'phone', 'fax', 'email'], 'string', 'max' => 255],
